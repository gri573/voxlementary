...
#if (defined LIGHT_SHAFTS && defined SMOKEY_WATER_LIGHTSHAFTS) || ((defined BLACK_OUTLINE || defined PROMO_OUTLINE) && defined OUTLINE_ON_EVERYTHING && defined END && defined ENDER_NEBULA) || defined WATER_REFRACT
...
void main() {
	...
	#if defined LIGHT_SHAFTS || defined WATER_REFRACT
